...
sudo apt-get install -y --no-install-recommends build-essential libbz2-dev libgdbm-dev libncursesw5-dev libreadline-dev libsqlite3-dev libssl-dev libz-dev
